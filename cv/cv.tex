...
\begin{minipage}[t]{2.7in}
  ...
  \\ Address: \myaddress
  \\ E-mail: \vspace{-0.03in} \texttt{\href{mailto:\myemail}{\myemail}}
...
\noindent
I am a computer science researcher with 6 years of academic
and industrial experience.
I published numerous peer-reviewed research publications,
and I am a member of the Scala programming language core team.
I personally led multiple software projects,
...
I have promoted Scala on 17 industrial and research conferences and meetups,
...
\newline Committee: Doug Lea, Erik Meijer, Viktor Kuncak, Ola Svensson
\bigskip
...
\dates{}
\newline\noindent Leading the research collaboration (\textasciitilde5 people) aimed at
                  developing
\newline\noindent novel high-performance concurrent data structures for traditional
\newline\noindent embedded systems.
\medskip
...
\dates{2011 -- 2012}
\newline\noindent Part of the working group (\textasciitilde10 people) that consolidated
                  existing Scala
\newline\noindent asynchronous programming frameworks from different open source
\newline\noindent stakeholders, and design a unified set of concurrency abstractions.
\medskip
...
\noindent
Authored 13 high-impact international research publications,
3 under submission,
...
\noindent{\bf Isolates, Channels and Event Streams for Composable }
\dates{}
% \newline\noindent{\bf Functional Programming}
% \smallskip
\newline\noindent{\bf Distributed Programming}
\dates{}
\newline\noindent Aleksandar Prokopec, Martin Odersky
% \bigskip
\medskip
...
\noindent
Gave 17 academic and industrial talks, 6 as an invited speaker.
\newline
...
\noindent
Reviewer or program committee member of 7 scientific conferences and journals.
...
\newline\noindent \faPhone~+1-315-312-2688
