...
\definecolor{DarkBlue}{HTML}{365FA0}
...
\dates{2004 -- 2009}
\newline\noindent M.A. in Computer Science, {\em June 2009}
\bigskip
...
& Maintained distributed logging infrastructure for Google Maps products.
& Worked on a massively distributed system used to analyze Geo product usage.
& Lead the implementation of a real-time distributed pipeline for spam detection.
...
\dates{2015}
\newline\noindent Co-organized, prepared materials and exercises, lead teaching staff on
...
\newline\noindent and >60,000 participants to date.
\vspace{0.05in}
\begin{easylist}[itemize]
& Coordinated a team of three lecturers during recording and
\newline the preparing of lecture materials.

& Lead teaching staff composed of graduate students,
\newline directing content production, designing and implementing exercise
\newline materials, managing the production of lecture videos,
\newline organizing community TAs on Coursera.
